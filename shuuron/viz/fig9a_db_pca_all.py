...
#all_feature
df_con_std_feature = df_con_std.drop([ "group_label", "mor_label", "ds_name"], axis = "columns")
X_con = df_con_std_feature.values
df_con_std_chin = df_con_std[df_con_std.ds_name == "chin"].drop([ "group_label", "mor_label", "ds_name"], axis = "columns")
X_chin = df_con_std_chin.values
df_con_std_prepro = df_con_std[df_con_std.ds_name == "prepro"].drop([ "group_label", "mor_label", "ds_name"], axis = "columns")
...
plt.scatter(df_pca_prepro_dup.loc[:, 0], df_pca_prepro_dup.loc[:, 1], alpha=1, label = "Both", c = "black", marker = "D", s = 25)
plt.grid()
...
plt.title("All features", fontsize = 28, pad = 18)
plt.show()
fig.savefig("./pca/fig9a_pca_allfeature.png")
