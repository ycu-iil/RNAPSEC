...
df = pd.read_csv("./prepro_results/preprocessing_result_ex.csv",index_col=False)
...
df_rna_features_2.to_csv("./prepro_results/preprocessing_result_rna.csv", index=False)
