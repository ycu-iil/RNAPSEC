...
df_result = pd.read_csv(f'./result_cutdata_{file_name}/smote_{smote_data}data/{opt_name}/data_{min_num}_{max_num}/cv_{fold_strategy}_valsplit_{val_fold_strategy}/es_{early_stopping_num}_val_fold_{val_fold}/total_result_val_{min_num}_{max_num}.csv',index_col=False)
print(file_name, min_num, max_num, "opt = ", opt_name, "smote = ", smote_data)
...
df_score.to_csv(f"./result_cutdata_{file_name}/smote_{smote_data}data/{opt_name}/data_{min_num}_{max_num}/cv_{fold_strategy}_valsplit_{val_fold_strategy}/es_{early_stopping_num}_val_fold_{val_fold}/score.csv", index = False)
...
plt.savefig(f"./result_cutdata_{file_name}/smote_{smote_data}data/{opt_name}/data_{min_num}_{max_num}/cv_{fold_strategy}_valsplit_{val_fold_strategy}/es_{early_stopping_num}_val_fold_{val_fold}/pr_curve.png")